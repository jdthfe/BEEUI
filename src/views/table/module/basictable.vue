<template>
  <ga-panel moduleName="复杂表头用法">
    <v-table highlight-row border :theader="theader" :columns="columns1" :data="data1" size="small" ref="table" @filterDataLength="getPageSize"
             @on-row-click="getRowData" :highlightRowIndex="highlightRowIndex">
    </v-table>
