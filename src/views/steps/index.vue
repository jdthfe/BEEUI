...
<script>
import basicsteps from './module/basicsteps.vue';
import simplesteps from './module/simplesteps.vue';
import iconsteps from './module/iconsteps.vue';
import nextsteps from './module/nextsteps.vue';
import errorsteps from './module/errorsteps.vue';
