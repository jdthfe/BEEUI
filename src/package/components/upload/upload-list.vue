    ...
    <li
        ...
        <transition name="fade">
            <i-progress
                ...
                :stroke-width="2"
                :percent="httpPercent?httperecent:parsePercentage(file.percentage)"
...
export default {
    ...
    methods: {
        ...
        parsePercentage (val) {
            if (this.httpPercent) this.httperecent = unDecimal(parseInt(val, 10));
            return unDecimal(parseInt(val, 10));
        }
    }
};
</script>
