    ...
    <div :class="[prefixCls + '-body']">
      <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
        ...
        <span
          ...
          v-show="currentView === 'date' || currentView === 'week'">{{ monthLabel }}</span>
        <span
      ...
      <div :class="[prefixCls + '-content']">
        ...
        <season-table
          ref="seasonTable"
          v-show="currentView === 'season'"
          :season="season"
          :year="year"
          :date="date"
          :selection-mode="selectionMode"
          :disabled-date="disabledDate"
          @on-pick="handleSeasonPick"
          @on-pick-click="handlePickClick"></season-table>
        <month-range-table
          ref="monthRangeTable"
          ...
          :date="date"
          :disabled-date="disabledDate"
          @on-pick="handleMonthRangePick"
          @on-pick-click="handlePickClick"></month-range-table>
        <time-picker
          ref="timePicker"
          show-date
...
<script>
  ...
  import SeasonTable from '../base/season-table.vue';
  import MonthRangeTable from '../base/month-range-table.vue';
  ...
  export default {
    name: 'DatePicker',
    mixins: [Mixin, Locale],
    components: {Icon, DateTable, YearTable, MonthTable, TimePicker, Confirm, WeekTable, SeasonTable, MonthRangeTable},
    data() {
      return {
        prefixCls: prefixCls,
