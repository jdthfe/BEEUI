    ...
    <div :class="classes">
        <div :class="[prefixCls+ '-list']" ref="hours">
            <ul :class="[prefixCls + '-ul']" @click="handleClickHours">
                <li :class="getCellCls(item)" v-for="(item, index) in hoursList" v-show="!item.hide" :cellidx="index">{{ formatTime(item.text) }}</li>
            </ul>
        </div>
        <div :class="[prefixCls+ '-list']" ref="minutes">
            <ul :class="[prefixCls + '-ul']" @click="handleClickMinutes">
                <li :class="getCellCls(item)" v-for="(item, index) in minutesList" v-show="!item.hide" :cellidx="index">{{ formatTime(item.text) }}</li>
            </ul>
        </div>
        <div :class="[prefixCls+ '-list']" v-show="showSeconds" ref="seconds">
            <ul :class="[prefixCls + '-ul']" @click="handleClickSeconds">
                <li :class="getCellCls(item)" v-for="(item, index) in secondsList" v-show="!item.hide" :cellidx="index">{{ formatTime(item.text) }}</li>
            </ul>
        </div>
    </div>
</template>
